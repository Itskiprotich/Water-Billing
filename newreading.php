 ...
 <?php include('header.php')?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Meter
        <small>New Reading</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Meter</a></li>
        <li class="active">New Reading</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="col-md-6">
          ...
          <form action="exenewreading.php" method="post">
            ...
            <label for="exampleInputEmail1">Meter Reading</label>
              <div class="input-group">
                ...
                <input type="number" name="Reading" class="form-control" placeholder="Meter Reading">
              </div>
            </div>
