      ...
      <div class="box">
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <tbody>
        <?php
        $result = mysqli_query($conn, "select * from clients order by id DESC") or die (mysqli_error($conn));
        $i = 0;
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td><?php echo $row['clients_first_name']; ?></td>
                <td><?php echo $row['clients_phone_number']; ?></td>
                <td><?php echo $row['clients_address']; ?></td>
                <td><?php echo $row['clients_plot_number']; ?></td>
                <td><?php echo $row['clients_meter_number']; ?></td>
                <td><?php echo $row['timestamps']; ?></td>


                <td>
                  
                       <a href="updclient.php<?php echo '?id=' . $id; ?>"> <button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="delclient.php<?php echo '?id=' . $id; ?>"
