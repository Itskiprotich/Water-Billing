...
<head>
  ...
  <title>Water Billing| Admins</title>
      ...
      <div class="box">
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <tbody>
        <?php
        $result = mysqli_query($conn, "select * from users order by id DESC") or die (mysqli_error($conn));
        $i = 0;
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td><?php echo $row['users_user_type']; ?></td>
                <td><?php echo $row['created']; ?></td>


                <td>
                  
                       <a href="updateadmin.php<?php echo '?id=' . $id; ?>"> <button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-user"></i> Admin
                                    </h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="deladmin.php<?php echo '?id=' . $id; ?>"
