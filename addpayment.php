          ...
          <form action="execpay.php" method="post">
            ...
            <label for="exampleInputEmail1">Bill</label>
              <div class="input-group">
                ...
                <select name="Bill" class="form-control select2" style="width: 100%;">
                <!-- php code select -->
                 <?php

                include('db/dbcon.php');
                $user_query = mysqli_query($conn, "SELECT * FROM billings") or die(mysqli_error());

                while ($row = mysqli_fetch_array($user_query)) {
                 ?>
                  
                  <option value="<?php echo $row['bill_number'];?>"><?php echo $row['client'];?> number <?php echo $row['bill_number'];?></option>
               <?php } ?>
                  <!-- end of code -->
                </select>
              </div>
            ...
            <label for="exampleInputEmail1">Payment Method</label>
              <div class="input-group">
                ...
                include('db/dbcon.php');
                $user_query = mysqli_query($conn, "SELECT * FROM types") or die(mysqli_error());
