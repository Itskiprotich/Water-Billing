    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <tbody>
        <?php
        $result = mysqli_query($conn, "select * from billings order by id DESC") or die (mysqli_error($conn));
        $i = 0;
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                <td><?php echo $i; ?></td>
                <td><?php echo $row['meter_reading_id']; ?></td>
                <td><?php echo $row['client']; ?></td>
                <td><?php echo $row['bill_number']; ?></td>
                <td><?php echo $row['bill_amount']; ?></td>
                <td><?php echo $row['bill_deadline']; ?></td>
                <td><?php echo $row['bill_balance']; ?></td>

                <td>
                  
                       <a href="viewbill.php<?php echo '?id=' . $id; ?>"> <button type="button" class="btn btn-primary"><i class="fa fa-eye"></i></button></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-user"></i> Bills
                                    </h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="delbills.php<?php echo '?id=' . $id; ?>"
