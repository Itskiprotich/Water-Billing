 ...
 <?php include('header.php')?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Metre Readings
        <small>All Metre Readings</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Metre Readings</a></li>
        <li class="active">All Metre Readings</li>
      </ol>
    </section>
      ...
      <div class="box">
        ...
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <tbody>
        <?php
        $result = mysqli_query($conn, "SELECT * FROM meter_readings ORDER by id DESC") or die (mysqli_error($conn));
        $i = 0;
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td><?php echo $row['meter_read_date']; ?></td>
                <td><?php echo $row['meter_reading']; ?></td>
                
                <td>
                  
                       <a href="updatemeter.php<?php echo '?id=' . $id; ?>"> <button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-user"></i> Meter
                                    </h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="delmeter.php<?php echo '?id=' . $id; ?>"
